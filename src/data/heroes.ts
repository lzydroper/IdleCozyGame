...
import type { EntityConfigBase } from './entityConfig';
...
export interface HeroConfig extends EntityConfigBase {
  kind: 'hero';
  heroClass: HeroClass;
...
export const HEROES_CONFIG: Record<string, HeroConfig> = {
  nova: {
    ...
    icon: Rocket,
    description: '前联合防卫军魔导机甲的备用驾驶员，擅长让魔导设施过载运转。'
  },
  buster: {
    id: 'buster',
    name: '巴斯特',
    ...
    icon: HandMetal,
    description: '在废土中行走了二十年的清道夫硬汉，能从垃圾堆里淘出核心部件。'
  },
  soldier: {
    id: 'soldier',
    name: '铁卫',
    ...
    icon: Shield,
    description: '避难所防御队长，擅长防御部署与阵地战。'
  },
  catherine: {
    id: 'catherine',
    name: '凯瑟琳',
    ...
    icon: HeartPulse,
    description: '前辐射防治所主任，常年镇守边陲、熟悉梦魇的侵蚀手段。'
  },
  roy: {
    id: 'roy',
    name: '罗伊',
    ...
    icon: Wrench,
    description: '前废土矿山工程师，擅长修理各种机械设备。'
  },
  mei: {
    id: 'mei',
    name: '阿梅',
    ...
    icon: Wheat,
    description: '对变异植物了如指掌的农学家，以魔法作物滋养队伍。'
  },
  zero: {
    id: 'zero',
    name: '赛罗',
    ...
    icon: Footprints,
    description: '废土信使，沿途留下魂印标记，熟悉所有地形与危险区域。'
  },
  healer: {
    id: 'healer',
    name: '艾拉',
    ...
    icon: FlaskConical,
    description: '精通净化药剂调配的药剂师，以奥术药剂维系队伍续航。'
  },
  apprentice: {
    id: 'apprentice',
    name: '小米',
    ...
    icon: Hammer,
    description: '在废土中长大的拾荒学徒，星野之间练就了一双巧手。'
  }
};
