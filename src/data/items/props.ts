...
import {
  BatteryFull, Cross, CupSoda, FlaskConical, Lamp, Orbit, Package, PackageOpen, Pill,
  Radar, ScanSearch, Soup, Syringe, TowerControl, Zap,
} from 'lucide-react';
...
export const PROPS_ITEMS: Record<string, ItemMeta> = {
  ...
  defensive_turret: { id: 'defensive_turret', name: '防御炮塔', description: '可部署的自动防御装置', category: 'item', sprite: { sheet: 'supplies', index: 2 }, icon: TowerControl },
  shield_battery: { id: 'shield_battery', name: '重载护盾电池', description: '用于部分高难地表救援任务的能量护盾电池。', category: 'item', sprite: { sheet: 'supplies', index: 9 }, icon: BatteryFull },
  geiger_counter: { id: 'geiger_counter', name: '盖革探测仪', description: '黄色外壳、带有科幻刻度表盘和雷达扫描的手持探测仪', category: 'item', sprite: { sheet: 'supplies', index: 12 }, icon: Radar },
  sanity_capsule: { id: 'sanity_capsule', name: '稳定胶囊', description: '维持精神稳定的胶囊药物', category: 'item', sprite: { sheet: 'supplies', index: 3 }, icon: Pill },
  warp_capsule: { id: 'warp_capsule', name: '跃迁胶囊', description: '梦境中的传送工具', category: 'item', sprite: { sheet: 'supplies', index: 4 }, icon: Orbit },
  ...
  deflective_lens: { id: 'deflective_lens', name: '偏光魔导镜片', description: '折射七彩极光的六角形魔导透镜', category: 'item', sprite: { sheet: 'supplies', index: 14 }, icon: ScanSearch },
