...
import { HEROES_CONFIG, STARTER_HERO_ID } from '../loaders/entities.loader';
import { COMBAT_CONFIG } from '../constants/combatConfig';
import { FACILITIES_CONFIG } from '../loaders/shelter.loader';
import type { FacilityType } from '../types/gameplay.types';
